...
-- Create policy for the public vendor view - anyone can view this safe data
CREATE POLICY "Anyone can view public vendor profiles" 
ON public.public_vendor_profiles 
FOR SELECT 
USING (true);
