...
SELECT v.id::uuid, v.name, v.description, v.type::category_type, v.slug, v.sort_order::integer FROM (VALUES
...
SELECT v.name, v.description, v.type::category_type, v.parent_id::uuid, v.slug, v.sort_order::integer
FROM (VALUES
