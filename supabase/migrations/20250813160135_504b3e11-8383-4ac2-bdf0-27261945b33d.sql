...
-- 1. Add RLS policies for rate_limit_counters table (already done above)

-- 2. Complete category setup with proper type casting
INSERT INTO categories (name, description, type, parent_id, slug, sort_order) 
SELECT v.name, v.description, v.type::listing_type, v.parent_id::uuid, v.slug, v.sort_order::integer
FROM (VALUES
