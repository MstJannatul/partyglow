-- COMPREHENSIVE SECURITY AND DATA INTEGRITY FIX
...
-- Add system-level RLS policy for rate_limit_counters
DROP POLICY IF EXISTS "System can manage rate limits" ON rate_limit_counters;
