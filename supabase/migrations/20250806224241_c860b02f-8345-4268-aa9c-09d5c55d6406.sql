...
-- Enhance inventory_items table with reservation tracking
...
-- Create trigger to auto-release expired reservations
...
AS $$
BEGIN
  -- Release expired reservations when cart items are accessed
  PERFORM release_expired_cart_reservations();
  RETURN NULL;
END;
$$;
